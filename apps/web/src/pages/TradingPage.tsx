...
import BullTradeLogo from "@/assets/BullTrade_logo.png";
import whiteLogo from "@/assets/BullTrade_logo.png";
import BullTradeIcon from "@/assets/bull-finance-icon.png";
import { TradingChart } from "@/components/TradingChart"; 
import { useWebSocket } from "@/hooks/useWebSocket";
import { PriceData } from "@/lib/price-store";
      ...
      <header className="border-b border-gray-200 dark:border-gray-700 px-6 py-3 bg-white dark:bg-gray-900">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-end gap-1">
            <img src={BullTradeIcon} alt="BullTradeIcon" className="h-8" />
            <img src={theme === 'dark' ? whiteLogo : BullTradeLogo} alt="BullTradeLogo" className="h-8" />
          </Link>
            ...
            <TabsContent value="chat" className="flex-1 p-4 overflow-y-auto mt-0">
              <div className="space-y-3">
                <div className="bg-gray-100 dark:bg-gray-800 rounded p-3">
                  <p className="text-xs text-gray-700 dark:text-gray-300">Welcome to BullTrade chat. Ask me anything about your trades!</p>
                </div>
                <div className="flex gap-2">
                  <input
                    type="text"
